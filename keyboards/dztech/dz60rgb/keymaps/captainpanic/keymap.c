...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
		[_BASE] = LAYOUT( /* Base */
		    ...
		    KC_LCTL,   KC_LGUI,  LM(_FN, MOD_LALT),        KC_SPC,            KC_RALT,   MO(_FN),    KC_LEFT,      KC_DOWN,           KC_RIGHT
      ),
		[_FN] = LAYOUT( /* FN */
        ...
        KC_TRNS,  KC_BTN1,  KC_MS_U,  KC_BTN2,  KC_TRNS,  KC_TRNS,  RGB_SAI,  RGB_SAD,  RGB_VAI,  RGB_VAD,  RGB_TOG,  RGB_MOD,  RGB_RMOD, RESET, \
        KC_TRNS,  KC_MS_L,  KC_MS_D,  KC_MS_R,  KC_TRNS,  KC_TRNS,  RGB_HUI,  RGB_HUD,  RGB_SPI,  RGB_SPD,  KC_TRNS,  KC_TRNS,            EEP_RST, \
